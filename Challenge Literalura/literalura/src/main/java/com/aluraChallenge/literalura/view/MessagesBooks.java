...
public final class MessagesBooks {

    public static void printBookDetails(Books libro){

        System.out.println(outMessageBook[3]);
        System.out.println("Titulo: " + libro.getTitulo());
        libro.getAutores().stream()
                .map(Authors::getNombre)
    ...
    public static void printBooksRegistred(List<Books> libros) {
        for (Books libro : libros) {
            ...
            System.out.println("Descargas: " + libro.getDescargas());
            System.out.println(MessagesBooks.outMessageBook[6]);
        }
    }
